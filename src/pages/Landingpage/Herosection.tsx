...
import test from "../../assets/img/landingimg.jpg";
    ...
    return (
        <>
            <div className="w-fit h-full flex justify-center items-center ">
                ...
                <div className="w-1/2 h-fit flex justify-center items-center object-cover">
                    <img className="h-full w-1/2 bg-blue-200 object-cover" alt="Image landing page" src={test}></img>
                </div>
            </div>
            <div className="absolute bottom-16 left-16 h-20 w-2/3 bg-white p-2 rounded-xl">
